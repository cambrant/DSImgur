...
"""
    ...
    DSImgur - Easily download images, Albums, Galleries and entire Profiles
    from Imgur. The most powerful Imgur Downloader!! You can use as program
    or as module!
"""
...
def main(argv=sys.argv[0]):
    parser = argparse.ArgumentParser(
        description="Easily download images, Albums, Galleries and entire"
                    "Profiles from Imgur. The most powerful Imgur Downloader!!"
                    "You can use as program or as module!")
